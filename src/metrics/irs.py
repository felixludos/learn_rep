...
# with some modifications for foundation (this) library
...
def compute_irs(ground_truth_data,
                ...
                random_state,
                num_train = 100,
                batch_size = 16, diff_quantile=0.99):
  ...
  if not active_mus.any():
    score_dict = {'avg_score': 0.0}
  else:
    score_dict = scalable_disentanglement_score(ys_discrete.T, active_mus.T,
