...
class OptimizedWildRelNet(tf.keras.Model):
  ...
  def __init__(self,
               edge_mlp=[512, 512, 512, 512],
               graph_mlp=[256,256],
               dropout_in_last_graph_layer=0.5,
...
class TwoStageModel(object):
  ...
  def __init__(self,
               embedding_model_class='other',
               reasoning_model_class=OptimizedWildRelNet,
               optimizer_fn=None):
  ...
  def model_fn(self, features, labels, mode, params):
    ...
    #else:
    context_embeddings, answer_embeddings = features["context"], features["answers"]
